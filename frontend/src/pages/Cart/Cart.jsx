                    ...
                    <div className="promo-section">
                            ...
                            <div className="fahasa-promo-suggestion">
                                <div className="suggestion-header">
                                    <span className="suggestion-title">
                                        {nextPotentialCoupon.name ||
                                            `Mã ${nextPotentialCoupon.code}`}
                                    </span>
                                    <div
                                        className="info-icon"
                                ...
                                <p className="suggestion-desc">
                                    Đơn hàng từ{" "}
                                    {formatPrice(
                                        nextPotentialCoupon.minOrderValue
                                    )}{" "}
                                    -{" "}
                                    {nextPotentialCoupon.description ||
                                        "Áp dụng cho các sản phẩm hợp lệ."}
                                </p>

                                <p className="suggestion-expiry">
                                    HSD:{" "}
                                    {nextPotentialCoupon.endDate
                                        ? new Date(
                                              nextPotentialCoupon.endDate
                        ...
                        {!nextPotentialCoupon && coupons.length > 0 && (
                            ...
                            >
                                <span>
                                    {" "}
                                    Bạn đã đủ điều kiện áp dụng các mã giảm giá
                                    hiện có!
                                </span>
                            </div>
                        )}
