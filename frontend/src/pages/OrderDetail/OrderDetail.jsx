  ...
  return (
    <div className="order-detail-container">
      ...
      <div className="timeline">
        ...
        {/* Bước 3: Hoàn tất hoặc Đã hủy */}
        <div className="step" style={{ color: getStepColor(order.status === "CANCEL" ? "Đã hủy" : "Hoàn tất", order.status) }}>
          <span>{order.status === "CANCEL" ? "Đã hủy" : "Hoàn tất"}</span>
        </div>
      ...
      <div className="product-list">
        ...
        {order.orderDetails.map((item) => (
          <div className="product-row" key={item.id}>
            ...
            <img
              src={item.imageUrl || "/book-default.png"}
              alt={item.bookTitle}
