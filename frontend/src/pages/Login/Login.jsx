...
const Login = () => {
    ...
    const [showConfirmRegisterPass, setShowConfirmRegisterPass] = useState(false);
    ...
    const onSubmitHandler = async (e) => {
        ...
        // Validation số điện thoại khi đăng ký
        if (isCreateAccount && phoneNumber && !/^\d{10,11}$/.test(phoneNumber)) {
            toast.error("Định dạng số điện thoại không hợp lệ! Nhập 10-11 chữ số.");
            setLoading(false);
            return;
        }

        // Validation xác nhận mật khẩu khi đăng ký
        if (isCreateAccount && password !== confirmRegisterPassword) {
                            ...
                            <form onSubmit={onSubmitHandler} className="login-form">
                                ...
                                {isCreateAccount && (
                                    <div className="form-group">
                                        ...
                                        <div className="form-input-wrapper password-wrapper">
                                            <input
                                                type={showConfirmRegisterPass ? "text" : "password"}
                                                id="confirmPassword"
                                                className="form-input pr-10"
                                            ...
                                            <span
                                                className="toggle-password"
                                                onClick={() => setShowConfirmRegisterPass(!showConfirmRegisterPass)}
                                            >
                                                {showConfirmRegisterPass ? <FaEyeSlash /> : <IoEyeSharp />}
                                            </span>
                                        </div>
                                    </div>
                                )}
